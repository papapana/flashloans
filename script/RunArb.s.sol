...
import {DeployArbUniswapBorrower} from "../script/DeployArbUniswapBorrower.s.sol";
...
contract RunTriArb is Script {
    // Create a  arbitrage opportunity
    ...
    ArbUniswapBorrower ArbFlashBorrower;
    ...
    function run() external {
        ...
        DeployArbUniswapBorrower deployArbUniswapBorrower = new DeployArbUniswapBorrower();
        (ArbFlashBorrower, networkConfig) = deployArbUniswapBorrower.run();
        ...
        console.log("FlashBorrower balance usdc", IERC20(USDC).balanceOf(address(ArbFlashBorrower)));
        ...
        console.log("Pair 1 triarb balance:", IERC20(pair1).balanceOf(address(ArbFlashBorrower)));
        ...
        IERC20(lendedToken).transfer(address(ArbFlashBorrower), fee);

        // Execute the arbitrage
        ArbFlashBorrower.borrow(IFLashLender(FLASHLENDER), lendedToken, 10000, data);
